...
When an external static magnetic field is applied to an atom, the hyperfine energy levels of the atom split, with spacing proportional to the magnitude of that field. This is called the Zeeman effect. Optical pumping of Rubidium is used in this experiment to examine this effect. A circularly polarized laser beam with wavelength of 794.8 nm was directed through Rubidium vapor surrounded by Helmholtz coils in all three dimensions, and detected by a photodiode. A radio frequency (RF) signal was applied to the Rb vapor. When changing the magnitude of the magnetic field created by the Helmholtz coil, the opacity of the Rb vapor would have a sudden increase when the external field was in resonance with the RF signal due to a stronger absorption. Varying the RF signal, we observed a change in the magnitude of the resonant field. From the relationship between the signal and the field, the Lande g-factor was determined for $^8$$^5$Rb, $g_{85}=0.34\pm0.02$, and $^8$$^7$Rb, $g_{87}=0.51\pm0.02$, which are consistent with theoretical values of 1/3 and 1/2 respectively. \\
...
\vspace*{-0.5cm}
\begin{equation}
I=\frac{V_{\textnormal{sweep}}/{G}}{R}
\label{vtoi}
\end{equation}

$N=11$ is the number of wires wrapped on each side and$R_{coil}=0.1639m$ is the average radius of the loop. G represent gain, which is 1 in this experiment and R is the recorder output resistance, which is $30 \Omega$. This is calculated by taking the voltage across the sensor resistor labeled "recorder output" on the horizontal magnetic field sweep on the optical pumping instrument and the monitor voltage, both of which measure the same current passing through the coils. The sweep field voltage is 30 times larger than the monitor voltage, and it is given that the monitor has a sensor resistance of $1 \Omega$. Using Ohm's law of $V=IR$, the resistance of the recorder output is easily found to be $30 \pm 1.4 \Omega $. \
...
\hline
100 & -0.11072$\pm$0.00000748 & 0.028362$\pm$0.00000648 & 0.098161$\pm$0.00000512\\
90 &-0.11074$\pm$0.00000751 &0.0.014205$\pm$0.00000764 &0.076429$\pm$0.00000637\\
80 &-0.11112$\pm$0.00000878 &0.00017474$\pm$0.00000669 &0.055776$\pm$0.00000433\\
70 &-0.11056$\pm$0.0000116 &-0.013514$\pm$0.00000872 &0.034854$\pm$0.0000054\\
60 &-0.11059$\pm$0.00001 &-0.027354$\pm$0.00000858 &0.013929$\pm$0.0000065\\
50 &-0.11086$\pm$0.0000124 &-0.041361$\pm$0.00000849 &-0.0065838$\pm$0.00000626\\
40 &-0.11082$\pm$0.0000122 &-0.055245$\pm$0.00000943 &-0.027583$\pm$0.00000667\\
30 &-0.11091$\pm$0.0000122 &-0.069241$\pm$0.0000111 &-0.048597$\pm$0.00000707\\
20 &-0.11177$\pm$0.0000114 &-0.084233$\pm$0.0000119 &-0.070356$\pm$0.00000881\\
10 &-0.11183$\pm$0.0000114 &-0.098259$\pm$0.0000296 &-0.091215$\pm$0.0000106\\
\end{tabular}
\end{ruledtabular}
\label{data}
\end{table}
...
(kHz) & (Gauss) & (Gauss)\\
\hline
100 & 0.139082$\pm$0.00001340 & 0.208881$\pm$0.0000126\\
90 & 0.124944$\pm$0.0000152 & 0.187169$\pm$0.0000139\\
80 & 0.1112947$\pm$0.0000155 & 0.166896$\pm$0.0000131\\
70 & 0.097046$\pm$0.0000203 & 0.145414$\pm$0.000017\\
60 & 0.083236$\pm$0.0000186 & 0.124519$\pm$0.0000165\\
50 & 0.069499$\pm$0.0000209 & 0.104276$\pm$0.0000187\\
40 & 0.055575$\pm$0.0000216 & 0.083237$\pm$0.0000189\\
30 & 0.041669$\pm$0.0000233 & 0.062313$\pm$0.0000193\\
20 &	0.027537$\pm$0.0000233 & 0.041414$\pm$0.0000202\\
10 &	0.013571$\pm$0.000041 & 0.020615$\pm$0.0000220\\
\end{tabular}
\end{ruledtabular}
\label{data2}
\end{table}
...
where B is the the resonant magnetic field and $\nu$ is the RF frequency. And it is easy to see that they have a linear relationship. $g_{F}$ can be calculate from the slope of the fit line, $m$:

\begin{equation}
g_{F}=\frac{h}{\mu_{0}} \times \frac{1}{m}=0.51\pm0.02 \textrm{ for } ^{87}Rb \textrm{ and } 0.34\pm0.02 \textrm{ for } ^{85}Rb
\label{gf}
\end{equation}

The uncertainty of $g_{F}$ is dominated by the error in recorder output resistance in Eq. \ref{vtoi}. The uncertainty of each resonant field and the slopes of the fit lines are both on the order of magnitude of $0.1\%$, but the recorder output resistance has an error of $4.7\%$. Since other quantities involved in finding $g_{F}$ have no or unknown uncertainty, e.g. N in Eq. \ref{vtob} does not have an error and RF signal has unknown error because it is output by a function generator, the error in R is used as the uncertainty of the $g_{F}$ values.\\


%____________Conclusion____________________________________________
\section{Conclusion}

In this experiment, $g_{F}$ is found to be $0.51\pm0.02$ for $^8$$^7$Rb and $0.34\pm0.02$ for $^8$$^5$Rb where the expected values are 1/2 and 1/3. The experimental values agree with the theoretical values within uncertainty. \\
